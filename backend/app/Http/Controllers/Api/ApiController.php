...
protected function respondSuccessCreate($data, $statusCode = 200, $headers = [])
    {
    ...
    protected function respondSuccessUpdate($data, $statusCode = 200, $headers = [])
    {
    ...
    protected function respondSuccessDelete($data, $statusCode = 200, $headers = [])
    {
